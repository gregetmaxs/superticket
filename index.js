...
console.log(chalk.red('=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+='))
  console.log(chalk.cyan(`Made by SuperStore`))
  console.log(chalk`{yellowBright Credits } | {blueBright Visa2Code} | {cyanBright https://discord.gg/TCKspMmWDH}`)
...
.setURL(`https://discord.gg/TCKspMmWDH`)
